...
chrome.storage.local.get(keys, function(result) {
    ...
    if (valMovieTooltip == "1" || valMovieTooltip == null) {
        $('a[href^="/film/"], [href^="https://www.csfd.cz/film/"]')
            ...
            .not('a[href*="-serie-"]')
            // example of serie url: https://www.csfd.cz/film/237486-pernikovy-tata/420272-serie-1/
            // example of episode url: https://www.csfd.cz/film/237486-pernikovy-tata/420276-cancer-man/
