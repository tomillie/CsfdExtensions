...
chrome.storage.local.get(keys, function (result) {
	...
	if (valImdb == 1 || valImdb == null ||
		...
		if (imdbLink) {
			...
			var apiUrl = "http://imdbapi.tomizzi.com/api.php?id=" + imdbId + "&api_key=" + apiKey;
		}
			...
			function placeVideoOnPage(id, duration) {
				...
				$("#videoPlayer1").parent().parent().before('<li>' +
																'<div class="ui-video-player">' + 
																	'&nbsp;&nbsp;<iframe width="660" height="371" src="http://www.youtube.com/embed/' + id + '?vq=hd1080" frameborder="0" allowfullscreen></iframe>' + 
